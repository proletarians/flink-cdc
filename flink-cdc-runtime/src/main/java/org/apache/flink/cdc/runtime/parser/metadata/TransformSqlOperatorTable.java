...
public class TransformSqlOperatorTable extends ReflectiveSqlOperatorTable {
    ...
    public static final SqlFunction AI_CHAT_PREDICT = new SqlFunction(
            "AI_CHAT_PREDICT",
            SqlKind.OTHER_FUNCTION,
    ...
    public static final SqlFunction GET_EMBEDDING = new SqlFunction(
            "GET_EMBEDDING",
            SqlKind.OTHER_FUNCTION,
    ...
    public static final SqlFunction AI_LANGCHAIN_PREDICT = new SqlFunction(
