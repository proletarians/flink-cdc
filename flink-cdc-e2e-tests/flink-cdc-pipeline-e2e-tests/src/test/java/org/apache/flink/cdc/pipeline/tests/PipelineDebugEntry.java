...
public class PipelineDebugEntry {
    public static void main(String[] args) throws Exception {
        ...
        String[] extArgs = {jobPath, "--use-mini-cluster", "true","--jar","/Users/wuzexian/IdeaProjects/flink-cdc-2/flink-cdc-connect/flink-cdc-pipeline-connectors/flink-cdc-pipeline-connector-elasticsearch/target/flink-cdc-pipeline-connector-elasticsearch-3.2-SNAPSHOT.jar"};
